...
export default async function CheckoutSuccessPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <div className="checkout-page" data-competing-sticky-action><div className="narrow-container checkout-main"><CheckoutStatus sessionId={raw || null} /></div></div>;
}
